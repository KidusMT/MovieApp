...
public class FragmentUpcoming extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragment_upcomming,container,false);

        recyclerView = v.findViewById(R.id.recycler_view_upcoming);
