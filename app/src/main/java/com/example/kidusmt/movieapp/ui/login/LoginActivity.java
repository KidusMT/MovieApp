...
public class LoginActivity extends BaseActivity
    ...
    //for getting the shared instance of the FirebaseAuth object
    private FirebaseAuth mAuth;

    private int RC_SIGN_IN = 0;//this value has to be changed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // using the shared instance of the Firebase user then we can check if the user has logged in or not
        mAuth = FirebaseAuth.getInstance();

        //-----------------------FACEBOOK LOGIN------------------------
        //handle login responses by the facebook button login
        callbackManager = CallbackManager.Factory.create();

        //the facebook login button in the loginActivity
        ...
        loginButton.registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onCancel() {
                        // App code
                        Toast.makeText(LoginActivity.this, "you're not valid user",
